...
public class TesterDeCasosConErroresLexico {
    ...
    private static final String testFilesDirectoryPath = "etapa1 - lexico/conErrores/";
    ...
    public TesterDeCasosConErroresLexico(String input){
        this.input = input;
    }
