...
public class TesterDeCasosConErroresEtapaCuatro {
    ...
    private static final String testFilesDirectoryPath = "etapa 4 - semantico pt.2/conErrores/";
    ...
    public TesterDeCasosConErroresEtapaCuatro(String input){
        this.input = input;
    }
