...
public class TesterDeCasosConErroresEtapaDos {
    ...
    private static final String testFilesDirectoryPath = "etapa 2 - sintactico/conErrores/";
    ...
    public TesterDeCasosConErroresEtapaDos(String input){
        this.input = input;
    }
