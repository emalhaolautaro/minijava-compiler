...
public class TesterDeCasosSinErroresLexico {

    private static final String msgExito = "[SinErrores]";
    private static final String testFilesDirectoryPath = "etapa1 - lexico/sinErrores/";
    ...
    public TesterDeCasosSinErroresLexico(String input){
        this.input = input;
    }
